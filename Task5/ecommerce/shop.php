...
if($_GET){
    if(isset($_GET['brand'])){
        if(is_numeric($_GET['brand'])){
            ...
            if($brandObject->find($_GET['brand'])->num_rows == 1){
                $products = $productObject->all(['id','name_en','details_en','price','image'],[['brand_id','=',$_GET['brand']],['status','=',1]])->fetch_all(MYSQLI_ASSOC);
            }else{
        ...
        if(is_numeric($_GET['subcategory'])){
            ...
            if($subcategoryObject->find($_GET['subcategory'])->num_rows == 1){
                $products = $productObject->all(['id','name_en','details_en','price','image'],[['subcategory_id','=',$_GET['subcategory']],['status','=',1]])->fetch_all(MYSQLI_ASSOC);
            }else{
                header('location:layouts/errors/404.php');die;
            }
        }else{
        ...
        if(is_numeric($_GET['category'])){
            ...
            if($categoryObject->find($_GET['category'])->num_rows == 1){
                $products = $productObject->all(['id','name_en','details_en','price','image'],[['category_id','=',$_GET['category']],['status','=',1]])->fetch_all(MYSQLI_ASSOC);
            }else{
                header('location:layouts/errors/404.php');die;
            }
        }else{
    ...
    $products = $productObject->all(['id','name_en','details_en','price','image'],[['status','=',1]])->fetch_all(MYSQLI_ASSOC);
}
