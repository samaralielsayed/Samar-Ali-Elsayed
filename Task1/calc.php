...
<html lang="en">
  ...
  <div class="container w-75 ">
        <div class="row border border-warning  mt-5">
           <div class="col-12 text-center text-success h1 mt-5 "> calculator</div>
            <div class="col-6 offset-3">
                <form action=" " method="post">
                    ...
                    <div class="form-group offset-2">
                        <!-- <button class="btn btn-outline-danger btn-sm">Get Data</button> -->
                        <input type="submit" name="sub" value="+" class="rounded-pill bg-warning px-3 ">
                        <input type="submit" name="sub" value="-" class="rounded-pill bg-warning px-3">
                        <input type="submit" name="sub" value="*" class="rounded-pill bg-warning px-3">
                        <input type="submit" name="sub" value="/" class="rounded-pill bg-warning px-3">
                        <input type="submit" name="sub" value="%" class="rounded-pill bg-warning px-3">
                        <input type="submit" name="sub" value="**"class="rounded-pill bg-warning px-3"><br>
                    </div>
                </form>
            </div>
            <div class="col-6 offset-3 mb-5 mt-5">
                <ul class="alert alert-success">
                    <li>The Result Equal : <?php echo  $message ?? ""; ?></li>
            </div>
